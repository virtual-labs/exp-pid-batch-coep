...
function BatchProcessBottleFillingInstrument()
{
	...
	htm=''
		...
		+'</div>'
     	...
     	+'<div class="row conf" >'
		+'<div class="col-sm-12">'
		+'<label><b>Enter no of proximity sensor for 1 liter</b></label>'
		+' <input class="form-select" id="ps1" type="number" min="0" max="5" value="0" tabindex="2"></input>'
		+'</div>'
		
		+'<div class="col-sm-12">'
		+'<label><b>Enter no of proximity sensor for 1.5 liter</b></label>'
		+' <input class="form-select" id="ps1Half" type="number" min="0" max="5" value="0" tabindex="3"></input>'
		+'</div>'

		+'<div class="col-sm-12">'
		+'<label><b>Enter no of proximity sensor for 3 liter</b></label>'
